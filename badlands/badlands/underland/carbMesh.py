...
class carbMesh():
    ...
    def get_active_layer(self, actlay, verbose=False):
        ...
        if verbose:
            print("   - Get active layer composition ", time.time() - time0)
            time0 = time.time()
    ...
    def update_active_layer(self, actlayer, elev, verbose=False):
        ...
        if verbose:
            print("   - Update active layer due to wave-induced erosion/deposition ", time.time() - time0)
    ...
    def update_layers(self, clastic, elev, verbose=False):
        ...
        if verbose:
            print("   - Update erosion/deposition ", time.time() - time0)
