...
class isoFlex:
    ...
    def get_flexure(self, elev, cumdiff, sea, boundsPt, ice, initFlex=False):
        """
        ...
        self.flex.qs += (
        self.rho_i * self.flex.g * numpy.reshape(iceload, (self.ny, self.nx))
        )
