...
/* See f2py2e/rules.py */
extern void F_FUNC_US(marine_distribution,MARINE_DISTRIBUTION)(double*,double*,double*,int*,int*,double*,double*,int*,int*,int*);
extern void F_FUNC(pitparams,PITPARAMS)(int*,double*,int*,double*,double*,double*,double*,double*,int*,int*);
...
diffsed,diffqz,diffbe = marine_distribution(elevation,seavol,qpr,nbe,sealevel,border,depids,pyslp,[pydnodes,pyids,pyrocknb])\n\nWrapper for ``marine_distribution``.\
\n\nParameters\n----------\n"
"elevation : input rank-1 array('d') with bounds (pydnodes)\n"
"seavol : input rank-2 array('d') with bounds (pydnodes,pyrocknb)\n"
"qpr : input rank-1 array('d') with bounds (pydnodes)\n"
"nbe : input rank-1 array('d') with bounds (pydnodes)\n"
"sealevel : input float\n"
"border : input rank-1 array('i') with bounds (pydnodes)\n"
"depids : input rank-1 array('i') with bounds (pyids)\n"
"pyslp : input rank-1 array('d') with bounds (pydnodes)\n"
"\nOther Parameters\n----------------\n"
"pydnodes : input int, optional\n    Default: shape(elevation, 0)\n"
"pyids : input int, optional\n    Default: shape(depids, 0)\n"
"pyrocknb : input int, optional\n    Default: shape(seavol, 1)\n"
"\nReturns\n-------\n"
"diffsed : rank-2 array('d') with bounds (pydnodes,pyrocknb)\n"
"diffqz : rank-1 array('d') with bounds (pydnodes)\n"
"diffbe : rank-1 array('d') with bounds (pydnodes)";
/* extern void F_FUNC_US(marine_distribution,MARINE_DISTRIBUTION)(double*,double*,double*,double*,double*,int*,int*,double*,double*,double*,double*,int*,int*,int*); */
static PyObject *f2py_rout_pdalgo_marine_distribution(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           void (*f2py_func)(double*,double*,double*,double*,double*,int*,int*,double*,double*,double*,double*,int*,int*,int*)) {
...
/*decl*/
    ...
    double *nbe = NULL;
    npy_intp nbe_Dims[1] = {-1};
    const int nbe_Rank = 1;
    PyArrayObject *capi_nbe_tmp = NULL;
    int capi_nbe_intent = 0;
    PyObject *nbe_capi = Py_None;
    double sealevel = 0;
    ...
    double *pyslp = NULL;
    npy_intp pyslp_Dims[1] = {-1};
    const int pyslp_Rank = 1;
    PyArrayObject *capi_pyslp_tmp = NULL;
    int capi_pyslp_intent = 0;
    PyObject *pyslp_capi = Py_None;
    double *diffsed = NULL;
    ...
    double *diffqz = NULL;
    npy_intp diffqz_Dims[1] = {-1};
    const int diffqz_Rank = 1;
    PyArrayObject *capi_diffqz_tmp = NULL;
    int capi_diffqz_intent = 0;
    double *diffbe = NULL;
    npy_intp diffbe_Dims[1] = {-1};
    const int diffbe_Rank = 1;
    PyArrayObject *capi_diffbe_tmp = NULL;
    int capi_diffbe_intent = 0;
    int pydnodes = 0;
    ...
    static char *capi_kwlist[] = {"elevation","seavol","qpr","nbe","sealevel","border","depids","pyslp","pydnodes","pyids","pyrocknb",NULL};
...
f2py_start_clock();
    ...
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "OOOOOOOO|OOO:pdalgo.marine_distribution",\
        capi_kwlist,&elevation_capi,&seavol_capi,&qpr_capi,&nbe_capi,&sealevel_capi,&border_capi,&depids_capi,&pyslp_capi,&pydnodes_capi,&pyids_capi,&pyrocknb_capi))
        return NULL;
/*frompyobj*/
    ...
    if (capi_elevation_tmp == NULL) {
        ...
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting 1st argument `elevation' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        elevation = (double *)(PyArray_DATA(capi_elevation_tmp));

    /* Processing variable sealevel */
        f2py_success = double_from_pyobj(&sealevel,sealevel_capi,"pdalgo.marine_distribution() 5th argument (sealevel) can't be converted to double");
    if (f2py_success) {
    ...
    if (capi_depids_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting 7th argument `depids' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        depids = (int *)(PyArray_DATA(capi_depids_tmp));

    /* Processing variable pydnodes */
    if (pydnodes_capi == Py_None) pydnodes = shape(elevation, 0); else
    ...
    if (f2py_success) {
    CHECKSCALAR(shape(elevation, 0) == pydnodes,"shape(elevation, 0) == pydnodes","1st keyword pydnodes","marine_distribution:pydnodes=%d",pydnodes) {
    /* Processing variable pyids */
    if (pyids_capi == Py_None) pyids = shape(depids, 0); else
        f2py_success = int_from_pyobj(&pyids,pyids_capi,"pdalgo.marine_distribution() 2nd keyword (pyids) can't be converted to int");
    if (f2py_success) {
    CHECKSCALAR(shape(depids, 0) == pyids,"shape(depids, 0) == pyids","2nd keyword pyids","marine_distribution:pyids=%d",pyids) {
    ...
    if (capi_qpr_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting 3rd argument `qpr' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        qpr = (double *)(PyArray_DATA(capi_qpr_tmp));

    /* Processing variable nbe */
    nbe_Dims[0]=pydnodes;
    capi_nbe_intent |= F2PY_INTENT_IN;
    capi_nbe_tmp = array_from_pyobj(NPY_DOUBLE,nbe_Dims,nbe_Rank,capi_nbe_intent,nbe_capi);
    if (capi_nbe_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting 4th argument `nbe' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        nbe = (double *)(PyArray_DATA(capi_nbe_tmp));
    ...
    if (capi_seavol_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting 2nd argument `seavol' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
    ...
    if (capi_border_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting 6th argument `border' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        border = (int *)(PyArray_DATA(capi_border_tmp));

    /* Processing variable pyslp */
    pyslp_Dims[0]=pydnodes;
    capi_pyslp_intent |= F2PY_INTENT_IN;
    capi_pyslp_tmp = array_from_pyobj(NPY_DOUBLE,pyslp_Dims,pyslp_Rank,capi_pyslp_intent,pyslp_capi);
    if (capi_pyslp_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting 8th argument `pyslp' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        pyslp = (double *)(PyArray_DATA(capi_pyslp_tmp));

    /* Processing variable diffqz */
    diffqz_Dims[0]=pydnodes;
    capi_diffqz_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    capi_diffqz_tmp = array_from_pyobj(NPY_DOUBLE,diffqz_Dims,diffqz_Rank,capi_diffqz_intent,Py_None);
    if (capi_diffqz_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting hidden `diffqz' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        diffqz = (double *)(PyArray_DATA(capi_diffqz_tmp));

    /* Processing variable diffbe */
    diffbe_Dims[0]=pydnodes;
    capi_diffbe_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    capi_diffbe_tmp = array_from_pyobj(NPY_DOUBLE,diffbe_Dims,diffbe_Rank,capi_diffbe_intent,Py_None);
    if (capi_diffbe_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting hidden `diffbe' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
        diffbe = (double *)(PyArray_DATA(capi_diffbe_tmp));
    ...
    capi_diffsed_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
    ...
    if (capi_diffsed_tmp == NULL) {
        PyObject *exc, *val, *tb;
        PyErr_Fetch(&exc, &val, &tb);
        PyErr_SetString(exc ? exc : pdalgo_error,"failed in converting hidden `diffsed' of pdalgo.marine_distribution to C/Fortran array" );
        npy_PyErr_ChainExceptionsCause(exc, val, tb);
    } else {
...
#endif
/*callfortranroutine*/
                (*f2py_func)(elevation,seavol,qpr,nbe,&sealevel,border,depids,pyslp,diffsed,diffqz,diffbe,&pydnodes,&pyids,&pyrocknb);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
        ...
        capi_buildvalue = Py_BuildValue("NNN",capi_diffsed_tmp,capi_diffqz_tmp,capi_diffbe_tmp);
/*closepyobjfrom*/
...
/*cleanupfrompyobj*/
    ...
    }  /*if (capi_diffbe_tmp == NULL) ... else of diffbe*/
    /* End of cleaning variable diffbe */
    }  /*if (capi_diffqz_tmp == NULL) ... else of diffqz*/
    /* End of cleaning variable diffqz */
    if((PyObject *)capi_pyslp_tmp!=pyslp_capi) {
        Py_XDECREF(capi_pyslp_tmp); }
    }  /*if (capi_pyslp_tmp == NULL) ... else of pyslp*/
    /* End of cleaning variable pyslp */
    ...
    if((PyObject *)capi_nbe_tmp!=nbe_capi) {
        Py_XDECREF(capi_nbe_tmp); }
    }  /*if (capi_nbe_tmp == NULL) ... else of nbe*/
    /* End of cleaning variable nbe */
    if((PyObject *)capi_qpr_tmp!=qpr_capi) {
        Py_XDECREF(capi_qpr_tmp); }
    }  /*if (capi_qpr_tmp == NULL) ... else of qpr*/
    /* End of cleaning variable qpr */
    } /*CHECKSCALAR(shape(depids, 0) == pyids)*/
    } /*if (f2py_success) of pyids*/
    /* End of cleaning variable pyids */
    } /*CHECKSCALAR(shape(elevation, 0) == pydnodes)*/
...
pitparams(pyngbs,pyarea,pydiff,pyprop,pypropa,pypropb,fillth,epsilon,pybounds,[pydnodes])\n\nWrapper for ``pitparams``.\
\n\nParameters\n----------\n"
...
/*decl*/
  ...
  double pypropa = 0;
  PyObject *pypropa_capi = Py_None;
  double pypropb = 0;
  PyObject *pypropb_capi = Py_None;
  double fillth = 0;
  ...
  int pydnodes = 0;
  PyObject *pydnodes_capi = Py_None;
  static char *capi_kwlist[] = {"pyngbs","pyarea","pydiff","pyprop","pypropa","pypropb","fillth","epsilon","pybounds","pydnodes",NULL};
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOOOOO|O:pdalgo.pitparams",\
    capi_kwlist,&pyngbs_capi,&pyarea_capi,&pydiff_capi,&pyprop_capi,&pypropa_capi,&pypropb_capi,&fillth_capi,&epsilon_capi,&pybounds_capi,&pydnodes_capi))
    return NULL;
/*frompyobj*/
  ...
  if (f2py_success) {
  /* Processing variable pypropa */
    f2py_success = double_from_pyobj(&pypropa,pypropa_capi,"pdalgo.pitparams() 5th argument (pypropa) can't be converted to double");
  if (f2py_success) {
  /* Processing variable pypropb */
    f2py_success = double_from_pyobj(&pypropb,pypropb_capi,"pdalgo.pitparams() 6th argument (pypropb) can't be converted to double");
  if (f2py_success) {
  /* Processing variable fillth */
    f2py_success = double_from_pyobj(&fillth,fillth_capi,"pdalgo.pitparams() 7th argument (fillth) can't be converted to double");
  if (f2py_success) {
  /* Processing variable epsilon */
    f2py_success = double_from_pyobj(&epsilon,epsilon_capi,"pdalgo.pitparams() 8th argument (epsilon) can't be converted to double");
  if (f2py_success) {
  /* Processing variable pybounds */
    f2py_success = int_from_pyobj(&pybounds,pybounds_capi,"pdalgo.pitparams() 9th argument (pybounds) can't be converted to int");
  if (f2py_success) {
  /* Processing variable pydnodes */
...
#endif
/*callfortranroutine*/
        (*f2py_func)(pyngbs,pyarea,&pydiff,&pyprop,&pypropa,&pypropb,&fillth,&epsilon,&pybounds,&pydnodes);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
  ...
  } /*if (f2py_success) of pypropb*/
  /* End of cleaning variable pypropb */
  } /*if (f2py_success) of pypropa*/
  /* End of cleaning variable pypropa */
...
/*frompyobj*/
  ...
  capi_demh_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
...
/*frompyobj*/
  ...
  capi_alays_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
...
/*frompyobj*/
  ...
  capi_newh_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  ...
  capi_news_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
...
"  diffsed = marine_distribution(elevation,seavol,sealevel,border,depids,pyslp,pydnodes=len(elevation),pyids=len(depids),pyrocknb=shape(seavol,1))\n"
"  pitparams(pyngbs,pyarea,pydiff,pyprop,pypropa,pypropb,fillth,epsilon,pybounds,pydnodes=shape(pyngbs,0))\n"
...
".");
   ...
   */
  PyDict_SetItemString(d, "_pdalgo_error", pdalgo_error);
  Py_DECREF(pdalgo_error);
