...
/*frompyobj*/
  ...
  capi_pc_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  ...
  capi_ptravel_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  ...
  capi_pwaveh_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
...
/*frompyobj*/
  ...
  capi_pydz_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
  ...
  capi_pydist_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
...
/*frompyobj*/
  ...
  capi_depopy_intent |= F2PY_INTENT_OUT|F2PY_INTENT_HIDE;
...
".");
   ...
   */
  PyDict_SetItemString(d, "_waveseds_error", waveseds_error);
  Py_DECREF(waveseds_error);
